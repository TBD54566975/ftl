...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct GetCertificationRequest {
    #[prost(message, optional, tag="1")]
    pub request: ::core::option::Option<CertificateContent>,
    #[prost(bytes="bytes", tag="2")]
    pub signature: ::prost::bytes::Bytes,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct GetCertificationResponse {
    #[prost(message, optional, tag="1")]
...
pub struct Certificate {
    #[prost(message, optional, tag="1")]
    pub content: ::core::option::Option<CertificateContent>,
    #[prost(bytes="bytes", tag="3")]
    pub controller_signature: ::prost::bytes::Bytes,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct PublishEventRequest {
    #[prost(message, optional, tag="1")]
    pub topic: ::core::option::Option<super::schema::v1::Ref>,
    #[prost(bytes="bytes", tag="2")]
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct GetModuleContextRequest {
    #[prost(string, tag="1")]
    pub module: ::prost::alloc::string::String,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct GetModuleContextResponse {
    #[prost(string, tag="1")]
    pub module: ::prost::alloc::string::String,
    ...
    pub databases: ::prost::alloc::vec::Vec<get_module_context_response::Dsn>,
}
/// Nested message and enum types in `GetModuleContextResponse`.
pub mod get_module_context_response {
    #[derive(Clone, PartialEq, ::prost::Message)]
    pub struct Ref {
        #[prost(string, optional, tag="1")]
        pub module: ::core::option::Option<::prost::alloc::string::String>,
