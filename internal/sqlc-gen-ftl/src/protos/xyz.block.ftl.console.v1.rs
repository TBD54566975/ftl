...
pub struct GetEventsRequest {
    #[prost(message, repeated, tag="1")]
    pub filters: ::prost::alloc::vec::Vec<get_events_request::Filter>,
    #[prost(int32, tag="2")]
    pub limit: i32,
    #[prost(enumeration="get_events_request::Order", tag="3")]
    pub order: i32,
}
/// Nested message and enum types in `GetEventsRequest`.
...
pub struct StreamEventsRequest {
    ...
    #[prost(message, optional, tag="2")]
    pub query: ::core::option::Option<GetEventsRequest>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
