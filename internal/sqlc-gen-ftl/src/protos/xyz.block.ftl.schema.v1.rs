...
pub struct DatabaseRuntime {
    #[prost(message, optional, tag="1")]
    pub read_connector: ::core::option::Option<DatabaseConnector>,
    #[prost(message, optional, tag="2")]
    pub write_connector: ::core::option::Option<DatabaseConnector>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct Decl {
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct Metadata {
    #[prost(oneof="metadata::Value", tags="5, 1, 10, 3, 4, 9, 2, 12, 6, 13, 11, 7, 8")]
