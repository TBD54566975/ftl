...
public enum Xyz_Block_Ftl_V1_Schema_Status: SwiftProtobuf.Enum {
...
extension Xyz_Block_Ftl_V1_Schema_Status: CaseIterable {
  ...
  public static let allCases: [Xyz_Block_Ftl_V1_Schema_Status] = [
    .offline,
    .starting,
    .online,
    .stopping,
...
public struct Xyz_Block_Ftl_V1_Schema_ModuleRuntime {
  ...
  public var hasArch: Bool {return self._arch != nil}
  /// Clears the value of `arch`. Subsequent reads from it will return its default value.
  public mutating func clearArch() {self._arch = nil}
...
public struct Xyz_Block_Ftl_V1_Schema_VerbRuntime {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var status: Xyz_Block_Ftl_V1_Schema_Status = .offline
...
extension Xyz_Block_Ftl_V1_Schema_ModuleRuntime: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ModuleRuntime"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Xyz_Block_Ftl_V1_Schema_ModuleRuntime, rhs: Xyz_Block_Ftl_V1_Schema_ModuleRuntime) -> Bool {
...
extension Xyz_Block_Ftl_V1_Schema_VerbRuntime: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".VerbRuntime"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "create_time"),
  ...
  public static func ==(lhs: Xyz_Block_Ftl_V1_Schema_VerbRuntime, rhs: Xyz_Block_Ftl_V1_Schema_VerbRuntime) -> Bool {
    if lhs._createTime != rhs._createTime {return false}
