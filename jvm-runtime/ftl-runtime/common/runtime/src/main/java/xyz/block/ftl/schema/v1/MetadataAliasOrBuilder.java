...
public interface MetadataAliasOrBuilder extends
    // @@protoc_insertion_point(interface_extends:xyz.block.ftl.schema.v1.MetadataAlias)
   ...
   * @return The kind.
   */
  xyz.block.ftl.schema.v1.AliasKind getKind();
