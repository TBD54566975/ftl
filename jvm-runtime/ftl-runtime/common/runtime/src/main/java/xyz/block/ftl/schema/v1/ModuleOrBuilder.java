...
public interface ModuleOrBuilder extends
    // @@protoc_insertion_point(interface_extends:xyz.block.ftl.schema.v1.Module)
   ...
   */
  java.util.List<xyz.block.ftl.schema.v1.Decl> 
      getDeclsList();
  /**
   * <code>repeated .xyz.block.ftl.schema.v1.Decl decls = 5 [json_name = "decls"];</code>
   */
  xyz.block.ftl.schema.v1.Decl getDecls(int index);
  /**
   * <code>repeated .xyz.block.ftl.schema.v1.Decl decls = 5 [json_name = "decls"];</code>
   */
  int getDeclsCount();
   ...
   * <code>repeated .xyz.block.ftl.schema.v1.Decl decls = 5 [json_name = "decls"];</code>
   */
  java.util.List<? extends xyz.block.ftl.schema.v1.DeclOrBuilder> 
      getDeclsOrBuilderList();
  /**
   * <code>repeated .xyz.block.ftl.schema.v1.Decl decls = 5 [json_name = "decls"];</code>
   */
  xyz.block.ftl.schema.v1.DeclOrBuilder getDeclsOrBuilder(
      int index);
   ...
   * @return The runtime.
   */
  xyz.block.ftl.schema.v1.ModuleRuntime getRuntime();
  /**
   * <code>.xyz.block.ftl.schema.v1.ModuleRuntime runtime = 31634 [json_name = "runtime"];</code>
   */
  xyz.block.ftl.schema.v1.ModuleRuntimeOrBuilder getRuntimeOrBuilder();
}
