<ul class="divide-y divide-white/5">
  <li class="relative flex items-center space-x-4 py-4">
    <div class="min-w-0 flex-auto">
      <div class="flex items-center gap-x-3">
        ...
        <h2 class="min-w-0 text-sm font-semibold leading-6 text-white">
          <a href="/modules/time" class="flex gap-x-2">
            ...
            <span class="whitespace-nowrap">go</span>
      ...
      >
        <p class="truncate">Deploys from FTL</p>
  ...
  <li class="relative flex items-center space-x-4 py-4">
      ...
      <div class="flex items-center gap-x-3">
        ...
        <h2 class="min-w-0 text-sm font-semibold leading-6 text-white">
          <a href="/modules/echo" class="flex gap-x-2">
            ...
            <span class="text-gray-400">/</span>
            <span class="whitespace-nowrap">kotlin</span>
            <span class="absolute inset-0" />
          </a>
        </h2>
      </div>
    ...
    <div
      class="rounded-full flex-none py-1 px-2 text-xs font-medium ring-1 ring-inset text-indigo-400 bg-indigo-400/10 ring-indigo-400/30"
    >
      Production
    </div>
    <svg
