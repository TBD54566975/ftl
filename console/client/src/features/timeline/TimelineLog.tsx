...
import { logLevelBadge, logLevelText, panelColor } from '../../utils/style.utils'
...
export const TimelineLog: React.FC<Props> = ({ log }) => {
  return (
    <>
      ...
      <p className='flex-auto py-0.5 text-xs leading-5 text-gray-500 dark:text-gray-400 overflow-hidden overflow-ellipsis w-full max-w-full'>
        <span className='text-gray-600 dark:text-white'>
          <pre className='whitespace-normal'>{log.message}</pre>
        </span>
      </p>
