...
const (
	...
	ConsoleServiceName = "xyz.block.ftl.v1.ConsoleService"
)
...
const (
	...
	ConsoleServicePingProcedure = "/xyz.block.ftl.v1.ConsoleService/Ping"
	// ConsoleServiceGetModulesProcedure is the fully-qualified name of the ConsoleService's GetModules
	// RPC.
	ConsoleServiceGetModulesProcedure = "/xyz.block.ftl.v1.ConsoleService/GetModules"
)
...
// ConsoleServiceClient is a client for the xyz.block.ftl.v1.ConsoleService service.
type ConsoleServiceClient interface {
	// Ping service for readiness.
	Ping(context.Context, *connect_go.Request[v1.PingRequest]) (*connect_go.Response[v1.PingResponse], error)
	GetModules(context.Context, *connect_go.Request[v1.GetModulesRequest]) (*connect_go.Response[v1.GetModulesResponse], error)
}

// NewConsoleServiceClient constructs a client for the xyz.block.ftl.v1.ConsoleService service. By
// default, it uses the Connect protocol with the binary Protobuf Codec, asks for gzipped responses,
// and sends uncompressed requests. To use the gRPC or gRPC-Web protocols, supply the
// connect.WithGRPC() or connect.WithGRPCWeb() options.
//
...
func NewConsoleServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) ConsoleServiceClient {
	...
	return &consoleServiceClient{
		...
		getModules: connect_go.NewClient[v1.GetModulesRequest, v1.GetModulesResponse](
			httpClient,
...
type consoleServiceClient struct {
	ping       *connect_go.Client[v1.PingRequest, v1.PingResponse]
	getModules *connect_go.Client[v1.GetModulesRequest, v1.GetModulesResponse]
}

// Ping calls xyz.block.ftl.v1.ConsoleService.Ping.
...
// GetModules calls xyz.block.ftl.v1.ConsoleService.GetModules.
func (c *consoleServiceClient) GetModules(ctx context.Context, req *connect_go.Request[v1.GetModulesRequest]) (*connect_go.Response[v1.GetModulesResponse], error) {
	return c.getModules.CallUnary(ctx, req)
}

// ConsoleServiceHandler is an implementation of the xyz.block.ftl.v1.ConsoleService service.
...
func NewConsoleServiceHandler(svc ConsoleServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/xyz.block.ftl.v1.ConsoleService/", mux
}
...
func (UnimplementedConsoleServiceHandler) Ping(context.Context, *connect_go.Request[v1.PingRequest]) (*connect_go.Response[v1.PingResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("xyz.block.ftl.v1.ConsoleService.Ping is not implemented"))
}

func (UnimplementedConsoleServiceHandler) GetModules(context.Context, *connect_go.Request[v1.GetModulesRequest]) (*connect_go.Response[v1.GetModulesResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("xyz.block.ftl.v1.ConsoleService.GetModules is not implemented"))
}
