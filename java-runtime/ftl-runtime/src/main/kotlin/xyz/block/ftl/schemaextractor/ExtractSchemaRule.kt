...
import org.jetbrains.kotlin.types.JavaType
...
class SchemaExtractor(
  ...
  private fun JavaType.toSchemaType(position: Position, tokenLength: Int): Type {
  ...
  private fun KtTypeReference.resolveType(): JavaType? {
  ...
  private fun JavaType.toClassDescriptor(): ClassDescriptor =
  ...
  companion object {
    ...
    private fun JavaType.isEmptyBuiltin(): Boolean {
      return this.fqNameOrNull()?.asString() == "ftl.builtin.Empty"
    }

    private fun JavaType.isUnit(): Boolean {
