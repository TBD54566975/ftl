...
func (e *MetricsExporter) Aggregation(kind metricSdk.InstrumentKind) aggregation.Aggregation {
	return metricSdk.DefaultAggregationSelector(kind)
}

func (e *MetricsExporter) Temporality(kind metricSdk.InstrumentKind) metricdata.Temporality {
	return metricSdk.DefaultTemporalitySelector(kind)
}
