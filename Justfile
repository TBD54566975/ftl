...
build-sqlc:
  ...
  @mk common/configuration/sql/{db.go,models.go,querier.go,queries.sql.go} : common/configuration/sql/queries.sql backend/controller/sql/schema sqlc.yaml -- "just init-db && sqlc generate"
