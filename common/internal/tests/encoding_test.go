...
func TestMarshal(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "UnregisteredSumType", input: struct{ D unregistered }{variant{"hello"}}, err: `the only supported interface types are enums or any, not tests_test.unregistered`},
...
func TestUnmarshal(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "UnregisteredSumType", input: `{"d":{"name":"Variant","value":{"message":"hello"}}}`, expected: struct{ D unregistered }{}, err: `the only supported interface types are enums or any, not tests_test.unregistered`},
	}
