...
func (m *RuntimeEvent) GetValue() isRuntimeEvent_Value {
	if m != nil {
		return m.Value
	}
	return nil
...
func (x *RuntimeEvent) GetDatabaseRuntimeEvent() *DatabaseRuntimeEvent {
	if x, ok := x.GetValue().(*RuntimeEvent_DatabaseRuntimeEvent); ok {
...
func (x *RuntimeEvent) GetModuleRuntimeBase() *ModuleRuntimeBase {
	if x, ok := x.GetValue().(*RuntimeEvent_ModuleRuntimeBase); ok {
		return x.ModuleRuntimeBase
	}
	return nil
}
...
func (x *RuntimeEvent) GetModuleRuntimeDeployment() *ModuleRuntimeDeployment {
	if x, ok := x.GetValue().(*RuntimeEvent_ModuleRuntimeDeployment); ok {
		return x.ModuleRuntimeDeployment
	}
	return nil
}
...
func (x *RuntimeEvent) GetModuleRuntimeScaling() *ModuleRuntimeScaling {
	if x, ok := x.GetValue().(*RuntimeEvent_ModuleRuntimeScaling); ok {
		return x.ModuleRuntimeScaling
	}
	return nil
}
...
func (x *RuntimeEvent) GetTopicRuntimeEvent() *TopicRuntimeEvent {
	if x, ok := x.GetValue().(*RuntimeEvent_TopicRuntimeEvent); ok {
...
func (x *RuntimeEvent) GetVerbRuntimeEvent() *VerbRuntimeEvent {
	if x, ok := x.GetValue().(*RuntimeEvent_VerbRuntimeEvent); ok {
...
var file_xyz_block_ftl_schema_v1_schema_proto_rawDesc = []byte{
	...
	0x45, 0x54, 0x5f, 0x4c, 0x41, 0x54, 0x45, 0x53, 0x54, 0x10, 0x02, 0x42, 0x4d, 0x50, 0x01, 0x5a,
	0x49, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x54, 0x42, 0x44, 0x35,
	0x34, 0x35, 0x36, 0x36, 0x39, 0x37, 0x35, 0x2f, 0x66, 0x74, 0x6c, 0x2f, 0x63, 0x6f, 0x6d, 0x6d,
