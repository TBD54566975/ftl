...
export class Metadata extends Message<Metadata> {
   ...
   *
   * @generated from field: repeated xyz.block.ftl.v1.language.Metadata.Pair LanguageMetadata = 2;
   */
  LanguageMetadata: Metadata_Pair[] = [];
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 2, name: "LanguageMetadata", kind: "message", T: Metadata_Pair, repeated: true },
  ]);
...
/**
 * @generated from message xyz.block.ftl.v1.language.Metadata.Pair
 */
export class Metadata_Pair extends Message<Metadata_Pair> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "xyz.block.ftl.v1.language.Metadata.Pair";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
