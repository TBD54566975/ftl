...
import type { Event } from '../../protos/xyz/block/ftl/v1/event_pb.ts'
...
export const Timeline = ({ timeSettings, filters }: { timeSettings: TimeSettings; filters: GetEventsRequest_Filter[] }) => {
