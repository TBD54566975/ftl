import { Call02Icon, Clock02Icon, PackageReceiveIcon, Rocket01Icon } from 'hugeicons-react'
...
const EVENT_TYPES: Record<string, EventFilter> = {
  ...
  cronScheduled: { label: 'Cron Scheduled', type: EventType.CRON_SCHEDULED, icon: <Clock02Icon className='w-4 h-4 text-indigo-500 ml-1' /> },
}
