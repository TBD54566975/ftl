...
/**
 * @generated from message xyz.block.ftl.publish.v1.PublishEventRequest
 */
export class PublishEventRequest extends Message<PublishEventRequest> {
  ...
  static readonly typeName = "xyz.block.ftl.publish.v1.PublishEventRequest";
...
/**
 * @generated from message xyz.block.ftl.publish.v1.PublishEventResponse
 */
export class PublishEventResponse extends Message<PublishEventResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "xyz.block.ftl.publish.v1.PublishEventResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
