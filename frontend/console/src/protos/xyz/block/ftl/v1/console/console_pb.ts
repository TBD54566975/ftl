...
/**
 * @generated from message xyz.block.ftl.v1.console.GetDeclRequest
 */
export class GetDeclRequest extends Message<GetDeclRequest> {
  /**
  ...
  /**
   * @generated from field: string decl_name = 2;
   */
  declName = "";

  constructor(data?: PartialMessage<GetDeclRequest>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "xyz.block.ftl.v1.console.GetDeclRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "module_name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "decl_name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): GetDeclRequest {
    return new GetDeclRequest().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): GetDeclRequest {
    return new GetDeclRequest().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): GetDeclRequest {
    return new GetDeclRequest().fromJsonString(jsonString, options);
  }

  static equals(a: GetDeclRequest | PlainMessage<GetDeclRequest> | undefined, b: GetDeclRequest | PlainMessage<GetDeclRequest> | undefined): boolean {
    return proto3.util.equals(GetDeclRequest, a, b);
  }
}
