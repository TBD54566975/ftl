...
// @generated from file xyz/block/ftl/v1/event.proto (package xyz.block.ftl.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from enum xyz.block.ftl.v1.EventType
 */
...
proto3.util.setEnumType(EventType, "xyz.block.ftl.v1.EventType", [
...
/**
 * @generated from enum xyz.block.ftl.v1.AsyncExecuteEventType
 */
...
proto3.util.setEnumType(AsyncExecuteEventType, "xyz.block.ftl.v1.AsyncExecuteEventType", [
...
/**
 * @generated from message xyz.block.ftl.v1.LogEvent
 */
export class LogEvent extends Message<LogEvent> {
  ...
  static readonly typeName = "xyz.block.ftl.v1.LogEvent";
...
/**
 * @generated from message xyz.block.ftl.v1.CallEvent
 */
export class CallEvent extends Message<CallEvent> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "xyz.block.ftl.v1.CallEvent";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message xyz.block.ftl.v1.DeploymentCreatedEvent
 */
export class DeploymentCreatedEvent extends Message<DeploymentCreatedEvent> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "xyz.block.ftl.v1.DeploymentCreatedEvent";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message xyz.block.ftl.v1.DeploymentUpdatedEvent
 */
export class DeploymentUpdatedEvent extends Message<DeploymentUpdatedEvent> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "xyz.block.ftl.v1.DeploymentUpdatedEvent";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "key", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message xyz.block.ftl.v1.IngressEvent
 */
export class IngressEvent extends Message<IngressEvent> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "xyz.block.ftl.v1.IngressEvent";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "deployment_key", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "request_key", kind: "scalar", T: 9 /* ScalarType.STRING */, opt: true },
...
/**
 * @generated from message xyz.block.ftl.v1.CronScheduledEvent
 */
export class CronScheduledEvent extends Message<CronScheduledEvent> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "xyz.block.ftl.v1.CronScheduledEvent";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "deployment_key", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message xyz.block.ftl.v1.AsyncExecuteEvent
 */
export class AsyncExecuteEvent extends Message<AsyncExecuteEvent> {
  ...
  /**
   * @generated from field: xyz.block.ftl.v1.AsyncExecuteEventType async_event_type = 6;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "xyz.block.ftl.v1.AsyncExecuteEvent";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "deployment_key", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "request_key", kind: "scalar", T: 9 /* ScalarType.STRING */, opt: true },
    { no: 3, name: "verb_ref", kind: "message", T: Ref },
...
/**
 * @generated from message xyz.block.ftl.v1.PubSubPublishEvent
 */
export class PubSubPublishEvent extends Message<PubSubPublishEvent> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "xyz.block.ftl.v1.PubSubPublishEvent";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "deployment_key", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "request_key", kind: "scalar", T: 9 /* ScalarType.STRING */, opt: true },
    { no: 3, name: "verb_ref", kind: "message", T: Ref },
...
/**
 * @generated from message xyz.block.ftl.v1.PubSubConsumeEvent
 */
export class PubSubConsumeEvent extends Message<PubSubConsumeEvent> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "xyz.block.ftl.v1.PubSubConsumeEvent";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "deployment_key", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "request_key", kind: "scalar", T: 9 /* ScalarType.STRING */, opt: true },
...
/**
 * @generated from message xyz.block.ftl.v1.Event
 */
export class Event extends Message<Event> {
  ...
  /**
   * @generated from oneof xyz.block.ftl.v1.Event.entry
   */
  entry: {
    /**
     * @generated from field: xyz.block.ftl.v1.LogEvent log = 3;
     */
    value: LogEvent;
    case: "log";
  } | {
    /**
     * @generated from field: xyz.block.ftl.v1.CallEvent call = 4;
     */
    value: CallEvent;
    case: "call";
  } | {
    /**
     * @generated from field: xyz.block.ftl.v1.DeploymentCreatedEvent deployment_created = 5;
     */
    value: DeploymentCreatedEvent;
    case: "deploymentCreated";
  } | {
    /**
     * @generated from field: xyz.block.ftl.v1.DeploymentUpdatedEvent deployment_updated = 6;
     */
    value: DeploymentUpdatedEvent;
    case: "deploymentUpdated";
  } | {
    /**
     * @generated from field: xyz.block.ftl.v1.IngressEvent ingress = 7;
     */
    value: IngressEvent;
    case: "ingress";
  } | {
    /**
     * @generated from field: xyz.block.ftl.v1.CronScheduledEvent cron_scheduled = 8;
     */
    value: CronScheduledEvent;
    case: "cronScheduled";
  } | {
    /**
     * @generated from field: xyz.block.ftl.v1.AsyncExecuteEvent async_execute = 9;
     */
    value: AsyncExecuteEvent;
    case: "asyncExecute";
  } | {
    /**
     * @generated from field: xyz.block.ftl.v1.PubSubPublishEvent pubsub_publish = 10;
     */
    value: PubSubPublishEvent;
    case: "pubsubPublish";
  } | {
    /**
     * @generated from field: xyz.block.ftl.v1.PubSubConsumeEvent pubsub_consume = 11;
     */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "xyz.block.ftl.v1.Event";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
