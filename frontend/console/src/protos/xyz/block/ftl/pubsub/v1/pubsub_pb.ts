...
/**
 * @generated from message xyz.block.ftl.pubsub.v1.ResetSubscriptionRequest
 */
export class ResetSubscriptionRequest extends Message<ResetSubscriptionRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "xyz.block.ftl.pubsub.v1.ResetSubscriptionRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message xyz.block.ftl.pubsub.v1.ResetSubscriptionResponse
 */
export class ResetSubscriptionResponse extends Message<ResetSubscriptionResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "xyz.block.ftl.pubsub.v1.ResetSubscriptionResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
