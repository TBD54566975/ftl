...
class ModuleRuntime(_message.Message):
    __slots__ = ("create_time", "language", "min_replicas", "os", "arch", "image", "endpoint")
    ...
    image: str
    endpoint: str
    def __init__(self, create_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., language: _Optional[str] = ..., min_replicas: _Optional[int] = ..., os: _Optional[str] = ..., arch: _Optional[str] = ..., image: _Optional[str] = ..., endpoint: _Optional[str] = ...) -> None: ...
