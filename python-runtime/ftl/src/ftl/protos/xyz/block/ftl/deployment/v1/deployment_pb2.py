...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'P\001ZRgithub.com/block/ftl/backend/protos/xyz/block/ftl/deployment/v1;deploymentpb'
