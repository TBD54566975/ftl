...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_DEPLOYMENTCHANGETYPE']._serialized_end=687
  ...
  _globals['_SCHEMASERVICE']._serialized_start=690
  _globals['_SCHEMASERVICE']._serialized_end=968
