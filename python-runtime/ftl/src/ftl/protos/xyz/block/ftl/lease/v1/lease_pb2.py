...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'P\001ZHgithub.com/block/ftl/backend/protos/xyz/block/ftl/lease/v1;leasepb'
