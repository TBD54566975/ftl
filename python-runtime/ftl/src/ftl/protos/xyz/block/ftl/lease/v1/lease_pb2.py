...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'P\001ZHgithub.com/TBD54566975/ftl/backend/protos/xyz/block/ftl/lease/v1;leasepb'
