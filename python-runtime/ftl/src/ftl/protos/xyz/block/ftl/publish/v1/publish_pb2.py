...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'P\001ZLgithub.com/block/ftl/backend/protos/xyz/block/ftl/publish/v1;publishpb'
