...
// Source: xyz.block.ftl.v1.schema.VerbRef in xyz/block/ftl/v1/schema/schema.proto
...
public class VerbRef(
...
) : Message<VerbRef, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  public override fun equals(other: Any?): Boolean {
    ...
    if (other !is VerbRef) return false
  ...
  public override fun toString(): String {
    ...
    return result.joinToString(prefix = "VerbRef{", separator = ", ", postfix = "}")
  }
  ...
  ): VerbRef = VerbRef(pos, name, module, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<VerbRef> = object : ProtoAdapter<VerbRef>(
      FieldEncoding.LENGTH_DELIMITED, 
      VerbRef::class, 
      "type.googleapis.com/xyz.block.ftl.v1.schema.VerbRef", 
      PROTO_3, 
      null, 
      "xyz/block/ftl/v1/schema/schema.proto"
    ) {
      public override fun encodedSize(`value`: VerbRef): Int {
      ...
      public override fun encode(writer: ProtoWriter, `value`: VerbRef): Unit {
      ...
      public override fun encode(writer: ReverseProtoWriter, `value`: VerbRef): Unit {
        writer.writeBytes(value.unknownFields)
        if (value.module != "") ProtoAdapter.STRING.encodeWithTag(writer, 3, value.module)
        if (value.name != "") ProtoAdapter.STRING.encodeWithTag(writer, 2, value.name)
        Position.ADAPTER.encodeWithTag(writer, 1, value.pos)
      ...
      public override fun decode(reader: ProtoReader): VerbRef {
      ...
      public override fun redact(`value`: VerbRef): VerbRef = value.copy(
