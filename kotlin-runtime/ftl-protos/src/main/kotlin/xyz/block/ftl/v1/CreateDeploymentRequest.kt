...
public class CreateDeploymentRequest(
...
) : Message<CreateDeploymentRequest, Nothing>(ADAPTER, unknownFields) {
  @field:WireField(
    tag = 2,
  ...
  ): CreateDeploymentRequest = CreateDeploymentRequest(schema, artefacts, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<CreateDeploymentRequest> = object :
        ProtoAdapter<CreateDeploymentRequest>(
      ...
      public override fun encodedSize(`value`: CreateDeploymentRequest): Int {
      ...
      public override fun encode(writer: ProtoWriter, `value`: CreateDeploymentRequest): Unit {
      ...
      public override fun encode(writer: ReverseProtoWriter, `value`: CreateDeploymentRequest):
          Unit {
        writer.writeBytes(value.unknownFields)
        DeploymentArtefact.ADAPTER.asRepeated().encodeWithTag(writer, 2, value.artefacts)
        if (value.schema != null) Module.ADAPTER.encodeWithTag(writer, 1, value.schema)
      ...
      public override fun decode(reader: ProtoReader): CreateDeploymentRequest {
      ...
      public override fun redact(`value`: CreateDeploymentRequest): CreateDeploymentRequest =
          value.copy(
