...
const (
	...
	TimelineServiceName = "xyz.block.ftl.v1.TimelineService"
)
...
const (
	...
	TimelineServicePingProcedure = "/xyz.block.ftl.v1.TimelineService/Ping"
	// TimelineServiceGetTimelineProcedure is the fully-qualified name of the TimelineService's
	// GetTimeline RPC.
	TimelineServiceGetTimelineProcedure = "/xyz.block.ftl.v1.TimelineService/GetTimeline"
	// TimelineServiceDeleteOldEventsProcedure is the fully-qualified name of the TimelineService's
	// DeleteOldEvents RPC.
	TimelineServiceDeleteOldEventsProcedure = "/xyz.block.ftl.v1.TimelineService/DeleteOldEvents"
)

// TimelineServiceClient is a client for the xyz.block.ftl.v1.TimelineService service.
type TimelineServiceClient interface {
	...
	DeleteOldEvents(context.Context, *connect.Request[v1.DeleteOldEventsRequest]) (*connect.Response[v1.DeleteOldEventsResponse], error)
}

// NewTimelineServiceClient constructs a client for the xyz.block.ftl.v1.TimelineService service. By
...
func NewTimelineServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) TimelineServiceClient {
	...
	return &timelineServiceClient{
		...
		deleteOldEvents: connect.NewClient[v1.DeleteOldEventsRequest, v1.DeleteOldEventsResponse](
			httpClient,
...
type timelineServiceClient struct {
	...
	deleteOldEvents *connect.Client[v1.DeleteOldEventsRequest, v1.DeleteOldEventsResponse]
}

// Ping calls xyz.block.ftl.v1.TimelineService.Ping.
...
// GetTimeline calls xyz.block.ftl.v1.TimelineService.GetTimeline.
...
// DeleteOldEvents calls xyz.block.ftl.v1.TimelineService.DeleteOldEvents.
func (c *timelineServiceClient) DeleteOldEvents(ctx context.Context, req *connect.Request[v1.DeleteOldEventsRequest]) (*connect.Response[v1.DeleteOldEventsResponse], error) {
	return c.deleteOldEvents.CallUnary(ctx, req)
}

// TimelineServiceHandler is an implementation of the xyz.block.ftl.v1.TimelineService service.
...
func NewTimelineServiceHandler(svc TimelineServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/xyz.block.ftl.v1.TimelineService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedTimelineServiceHandler) Ping(context.Context, *connect.Request[v1.PingRequest]) (*connect.Response[v1.PingResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("xyz.block.ftl.v1.TimelineService.Ping is not implemented"))
}
...
func (UnimplementedTimelineServiceHandler) GetTimeline(context.Context, *connect.Request[v1.GetTimelineRequest]) (*connect.Response[v1.GetTimelineResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("xyz.block.ftl.v1.TimelineService.GetTimeline is not implemented"))
}

func (UnimplementedTimelineServiceHandler) DeleteOldEvents(context.Context, *connect.Request[v1.DeleteOldEventsRequest]) (*connect.Response[v1.DeleteOldEventsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("xyz.block.ftl.v1.TimelineService.DeleteOldEvents is not implemented"))
}
