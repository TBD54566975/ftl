...
func New(ctx context.Context, conn libdal.Connection, encryption *encryption.Service, pubsub *pubsub.Service, cron *cronjobs.Service, registryFactory func(c libdal.Connection) aregistry.Service) *DAL {
	var d *DAL
	db := dalsql.New(conn)
	d = &DAL{
