...
WHERE EXISTS (SELECT 1
              ...
              HAVING COUNT(*) = $2::BIGINT -- Number of unique digests provided
)
`
...
func (q *Queries) GetDeploymentsWithArtefacts(ctx context.Context, digests [][]byte, count int64) ([]GetDeploymentsWithArtefactsRow, error) {
