...
--
-- Name: encrypted_identity; Type: DOMAIN; Schema: public; Owner: -
--

CREATE DOMAIN public.encrypted_identity AS bytea;
...
--
-- Name: identity_keys; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.identity_keys (
    id bigint NOT NULL,
    private public.encrypted_identity NOT NULL,
...
--
-- Name: identity_keys_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.identity_keys ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.identity_keys_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: identity_keys identity_keys_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
